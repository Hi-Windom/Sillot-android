 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/21 11:52
 * updated: 2024/8/21 11:52
 */
...
class ActivityRunInMultiWindowModeWorker(private val context: Context, params: WorkerParameters) : Worker(context, params) {
    private val TAG = "workers/ActivityRunInBgWorker.kt"
    @SuppressLint("ServiceCast")
    override fun doWork(): Result {
        val activityClassName = inputData.getString("activity")
