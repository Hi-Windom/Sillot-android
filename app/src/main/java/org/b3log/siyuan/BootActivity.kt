 ...
 *
 * lastModified: 2024/7/11 下午10:01
 * updated: 2024/7/11 下午10:01
 */
...
//        }
    ...
    private fun showAgreements() {
        ...
        msg.movementMethod = ScrollingMovementMethod()
        msg.text = Html.fromHtml(agreement, Html.FROM_HTML_MODE_LEGACY)
        val ab = AlertDialog.Builder(this)
        ab.setTitle("使用须知 / Notice")
        ab.setView(msg)
        ab.setCancelable(false)
        ab.setPositiveButton("同意/Agree") { dialog: DialogInterface?, which: Int ->
            val b = Bundle()
        ...
        ab.setNegativeButton("拒绝/Decline") { dialog: DialogInterface?, which: Int ->
            val b = Bundle()
    ...
    private val agreement = """<h2 id="隐私政策" updated="20220212224529">隐私政策</h2>
<ul>
